...
export async function handler(event: any, context: Context) {
    ...
    async function doQuery() {
        ...
        if (event.info.fieldName === 'getAllCuisines') {

            try {
                const result = await getAllCuisines(g)
                console.log(result)
                return result
            }
            catch (e) {
        ...
        if (event.info.fieldName === 'getAllRestaurants') {

            try {
                const result = await getAllRestaurants(g)
                console.log(result)
                return result
            }
            catch (e) {
        ...
        if (event.info.fieldName === 'getRestaurantInfo') {

            try {
                const result = await getRestaurantInfo(g, event.arguments.input.name)
                console.log(result)
                return result
            }
            catch (e) {
        ...
        if (event.info.fieldName === "getReviewsLikesDislikes") {

            try {
                const result = await getReviewsLikesDislikes(g, event.arguments.input.restaurantName)
                console.log(result)
                return result
            }
            catch (e) {
